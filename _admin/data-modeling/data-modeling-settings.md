...
| [Entity Category](set-entity-category.html#) | Specifies how to categorize the data in the column: person, place, time, and so on. Important for configuring SearchIQ <span class="label label-beta">Beta</span>  <span class="label label-beta">De-support 7.0</span>. |
| SearchIQ Enabled | Indicates if the column is enabled for SearchIQ <span class="label label-beta">Beta</span>  <span class="label label-beta">De-support 7.0</span>. |
