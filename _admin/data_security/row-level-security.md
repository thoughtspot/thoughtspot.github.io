...
For a list of operators and functions you can use to build these expressions see [Row level security rules reference](/reference/rls-rule-builder-reference.html#).
