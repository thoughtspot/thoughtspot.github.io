...
-   **[Connect with TCL and create a schema](/admin/loading/prep-schema-for-load.html)**  
...
-   **[Write a SQL script to create the schema](/admin/loading/create-schema_with_script.html)**  
...
-   **[Schema creation examples](/admin/loading/create-schema_example.html)**  
...
-   **[Upload and run a SQL script)](/admin/loading/upload-sql-script.html)**  
