...
<col width="50%" />
  ...
  <tr>
    ...
    <td>We recommend that you use <code>DOUBLE</code>, because it has a range of 15 significant digits, <code>1.7E +/- 308</code>.<code>FLOAT</code> has a range of 7 significant digits, <code>3.4E +/- 38</code>.</td>s
  </tr>
  <tr>
    <td>Boolean</td>
