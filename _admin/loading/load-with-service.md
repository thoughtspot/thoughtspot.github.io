...
<button id="btn-copy" type="button" rel='tipsy' class="btn btn-copy" data-copied-hint="Copied!" data-placement="top" title="Copy" data-clipboard-text="curl -i https://localhost:8442/ts_dataservice/v1/public/ping"><ion-icon name="copy-outline"></ion-icon></button>
   ```
