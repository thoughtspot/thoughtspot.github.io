...
Version 1.1.2 supports auto-redirect Single Sign-On (SSO) for clusters with SSO enabled. For details, see [Mobile release notes]({{ site.baseurl }}/admin/mobile/notes-mobile.html#).
