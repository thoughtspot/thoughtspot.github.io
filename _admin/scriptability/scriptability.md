...
- [export](#export-object) the object(s), edit the object(s) by modifying its [ThoughtSpot Scripting Language]({{ site.baseurl }}/admin/scriptability/tsl.html) (`TSL`) representation, and [import](#update-object) the updated file(s) to modify the existing object *or*
...
- [export](#export-object) the object(s), edit the object(s) by modifying its [ThoughtSpot Scripting Language]({{ site.baseurl }}/admin/scriptability/tsl.html) (`TSL`) representation, and [import](#migrate-object) the updated file(s) to the new cluster *or*
...
{: id="edit-tsl"}
## Edit the TSL file
You can edit the `TSL` file in one of two ways. You can [export](#export-object) the object(s) and edit the file(s) in any text editor, before you import it. Or, you can use the [in-app `TSL` editor](#itself-editor) to edit, validate, and publish the object(s). Refer to [ThoughtSpot Scripting Language]({{ site.baseurl }}/admin/scriptability/tsl.html) for information on syntax in the TSL files.
...
4. The TSL editor opens. Edit the TSL file(s), using the syntax specified in [ThoughtSpot Scripting Language]({{ site.baseurl }}/admin/scriptability/tsl.html).
    ...
    - **Help**: Documentation. This links to the [ThoughtSpot Scripting Language]({{ site.baseurl }}/admin/scriptability/tsl.html) documentation.  
