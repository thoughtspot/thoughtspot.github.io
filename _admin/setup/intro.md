...
-   **[Test network connectivity between nodes](/admin/setup/test-network.html)**  
...
-   **[Set the relay host for SMTP (email)](/admin/setup/set-up-relay-host.html)**  
...
-   **[Set up a fiscal calendar year](/admin/setup/set-custom-calendar.html)**  
...
-   **[Configure SSL (secure socket layers)](/admin/setup/SSL-config.html)**  
...
-   **[Configure SAML](/admin/setup/configure-SAML-with-tscli.html)**  
...
-   **[About LDAP integration](/admin/setup/about-LDAP.html)**  
...
-   **[Configure a NAS file system](/admin/setup/NAS-mount.html)**  
...
-   **[Set up monitoring](/admin/setup/set-up-monitoring.html)**  
...
-   **[Network ports](/admin/setup/firewall-ports.html)**  
...
-   **[About load balancing and proxies](/admin/setup/about-load-balancer-configuration.html)**  
