...
<li><a href="{{ "/admin/mobile/use-mobile.html "| prepend: site.baseurl }}">Mobile App</a><br>Access your ThoughtSpot cluster to search Answers and Pinboards, and create Pinboards.</li>
</ul>
