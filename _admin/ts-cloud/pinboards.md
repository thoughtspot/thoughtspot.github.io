...
To export a scriptable file, click the More icon ![]({{ site.baseurl }}/images/icon-more-10px.png){: .inline} at the top right corner of the Pinboard, and select **Export as TML**. You can export Pinboard and the underlying data source, or Worksheet, or just the Pinboard.
