---
title: [Delete a table with dependent objects from a BigQuery connection]
...
When all dependencies are removed, you can delete the table. See [Delete a table from a BigQuery connection]({{ site.baseurl }}/admin/ts-cloud/ts-cloud-embrace-gbq-delete-table.html)
