---
title: [Edit a BigQuery connection]
...
To remove a table from a connection, delete it from the connection details page. For more information, see: [Delete a table]({{ site.baseurl }}/admin/ts-cloud/ts-cloud-embrace-gbq-delete-connection.html).
