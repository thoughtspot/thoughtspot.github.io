    ...
    <table>
     ...
     <tr>
      ...
      <tr id="email">
        ...
        <p>Note that during cluster configuration, the domain is specified. ThoughtSpot does not accept emails outside this domain. <a href="{{ site.baseurl }}/appliance/contact.html">Contact ThoughtSpot Support</a> to add new email domains to your list of allowed domains.</p></td>
      </tr>    
      <tr id="welcome-email">     
