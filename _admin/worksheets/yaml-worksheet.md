...
To work with Worksheet migration in ThoughtSpot, you can download Worksheets to a flat file in `yaml` format, modify it, and subsequently upload this file either to the same cluster, or to a different cluster.

{: id="syntax"}
##  Syntax of the Worksheet YAML file

The YAML file for worksheet migration has a specific syntax.
