...
5. Now you're ready to either [embed a visualization](../embedding-viz/embed-a-viz.html#) or [use the REST API to get data](../data-api/use-data-api-read.html#) from ThoughtSpot and display it within your Web page or application.
