...
---
You can embed the full search experience into an iframe with different navigation views and toggle options. Before you can enable full embed, you need to [enable the JavaScript API \(JS API\)]({{ site.baseurl }}/app-integration/JSAPI/enable-JS-API.html#) and authenticate to ThoughtSpot.
