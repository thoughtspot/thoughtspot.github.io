...
Runtime Filters provide ability to filter data at the time of retrieval using [Embedding](/admin/embedding-viz/about-embedding-viz.html#) or the [REST API](/admin/data-api/about-data-api.html#). This is done by providing filter information through the URL query parameters.
