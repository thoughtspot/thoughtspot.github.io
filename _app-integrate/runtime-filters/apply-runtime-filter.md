...
2.  Use the [Data API](/admin/data-api/use-data-api-read.html#) or [Visualization Embedding](/admin/embedding-viz/embed-a-viz.html#) to retrieve the answer or pinboard you want to use.
