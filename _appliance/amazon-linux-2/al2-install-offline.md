...
sudo parted -s /dev/$TS_DISK mkpart primary xfs 0% 100%</code></pre></p>
  <br/>
    ...
    <dlentry id="admin_uid">
      <dt>admin_uid</dt>
      <dd>The admin user ID parameter. If using ssh, use the default values. If using SSM, the <code>ssm_user</code> uses the default value, <code>1001</code>. You must choose a new value.<br/>
</dd>
    </dlentry>
    <dlentry id="admin-gid">
      <dt>admin_gid</dt>
      <dd>The admin user group ID. Use the default values. If using ssh, use the default values. If using SSM, the <code>ssm_user</code> uses the default value, <code>1001</code>. You must choose a new value.<br/>
</dd>
    </dlentry>
    <dlentry id="ssh_user">
      <dt>ssh_user</dt>
