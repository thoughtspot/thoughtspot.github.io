...
7. Configure the instances by choosing the number of EC2 instances you need.
   ...
   **S3 storage setting**: If you are going to use the S3 storage option, go to the **IAM role** menu. ThoughtSpot recommends that you restrict access to a specific S3 bucket. Create a new IAM role that provides access to the specific bucket, and select it. For details on that, click **Create new IAM role**.
