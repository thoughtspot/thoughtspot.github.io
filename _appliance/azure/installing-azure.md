...
5. In the [ThoughtSpot login window]({{ site.baseurl }}/appliance/azure/installing-azure.html#ts-login), enter admin credentials, and click **Sign in**. Ask your network administrator if you do not know the network credentials.
