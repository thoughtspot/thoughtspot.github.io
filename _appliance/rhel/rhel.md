...
---
You have the flexibility to run ThoughtSpot on an RHEL 7.7 or 7.8 image that your organization manages internally. ThoughtSpot certifies RHEL 7.7 and 7.8 on the following platforms:
