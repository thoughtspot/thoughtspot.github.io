...
After you finish, go to the <a href="https://community.thoughtspot.com/customers/s/contactsupport">ThoughtSpot Support website</a> and use the support ticket for installation tasks. If necessary, create a new ticket.
