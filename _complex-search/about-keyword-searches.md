...
---
In addition to column names, values, and filters, the search bar also accepts keywords.  You can access a list of keywords and other reference materials in the [references]({{ site.baseurl }}/reference/keywords.html#) section or in the help. Open the help by clicking **Help** on the top navigation bar.
