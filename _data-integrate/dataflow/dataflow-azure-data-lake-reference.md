---
title: [Azure Data Lake Gen2 connection reference]
summary: Learn about the fields used to create an Azure Data Lake Gen2 connection with ThoughtSpot DataFlow.
last_updated: 09/14/2020
sidebar: mydoc_sidebar
permalink: /:collection/:path.html
---

Here is a list of the fields for an Azure Data Lake Gen2 connection in ThoughtSpot DataFlow. You need specific information to establish a seamless and secure connection.
