...
4. Specify the sync properties for Azure Synapse:
   ...
   * [Escape character]({{ site.baseurl }}/data-integrate/dataflow/dataflow-azure-synapse-reference.html#dataflow-azure-synapse-sync-escape-character)<br/>Specify this character to escape text qualifiers in source data.<br/>Optional field.
