...
4. Specify the sync properties for Google BigQuery:
   ...
   * [Escape character]({{ site.baseurl }}/data-integrate/dataflow/dataflow-google-bigquery-reference.html#dataflow-google-bigquery-sync-escape-character)<br/>Specify this character to escape text qualifiers in source data.<br/>Optional field.
