...
You can set these properties on Windows by using the [ODBC Administrator](/admin/clients/change-odbc-windows.html#).
...
For JDBC, these properties are passed as key value pairs in the connect string. For more information, see [Use the JDBC Driver](/admin/clients/use-jdbc-driver.html#).
