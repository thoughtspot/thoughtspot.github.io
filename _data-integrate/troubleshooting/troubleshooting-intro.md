...
-   **[Enabling ODBC Logs on Windows]({{ site.baseurl }}/data_integration/troubleshooting/troubleshooting-ODBC.html)**  
...
-   **[Enabling ODBC Logs on Linux or Solaris]({{ site.baseurl }}/data_integration/troubleshooting/enable-ODBC-log-linux.html)**  
...
-   **[Enabling JDBC Logs]({{ site.baseurl }}/data_integration/troubleshooting/JDBC-logging.html)**  
To enable logging for JDBC, add the logging parameters to the connect string. Logs are stored on ThoughtSpot.
-   **[Schema not found error]({{ site.baseurl }}/data_integration/troubleshooting/schema-not-found.html)**  
...
-   **[How to improve throughput of the load]({{ site.baseurl }}/data_integration/troubleshooting/how-to-improve-throughput-of-the-load.html)**  
