...
ThoughtSpot supports a wide range of [date and timestamp formats](../../reference/date_formats_for_loading.html#) in the CSV file. Blank values in user uploaded CSV files are interpreted as NULL values. These include the values (case insensitive):
