...
By default, [local authentication]({{ site.baseurl }}/admin/setup/internal-auth.html) is enabled. Use this article to learn how to configure a SAML integration with an external IdP. To configure SAML in an embedded environment, refer to [SAML SSO authentication](https://docs.thoughtspot.com/visual-embed-sdk/en/?pageid=saml-sso){: target="_blank"}.
