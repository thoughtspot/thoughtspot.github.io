...
summary: "The TQL service APIs enable you to the query the ThoughtSpot TQL cli from a remote machine."
...
## Requirements
- Client must contact the TQL service over a standard HTTPS port (i.e. 443).
- Client must authenticate before using any REST API.
- Client must be authorized to perform certain TQL operations.
