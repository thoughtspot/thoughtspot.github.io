...
tscli [-h]
      ...
      [--cluster ]
      [--zoo ]
      {access,alert,ansible,backup,backup-policy,calendar,callhome,cassandra,cluster,command,csp,dr-mirror,etl,event,feature,fileserver,firewall,hdfs,ipsec,logs,map-tiles,monitoring,nas,node,notification,onboarding,patch,rpackage,saml,scheduled-pinboards,set,smtp,snapshot,snapshot-policy,socialproof,ssl,storage,support,tokenauthentication}
</pre>
