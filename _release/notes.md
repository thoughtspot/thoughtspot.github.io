...
* To monitor headlines, you simply have to click the follow icon in the top right corner of the Pinboard.
  ![Monitor headlines with Follow]({{ site.baseurl }}/images/follow.png "Monitor headlines with Follow") |

* The **SpotIQ Follow** interface lists all the headlines you follow.
  ![SpotIQ Follow management interface]({{ site.baseurl }}/images/spotiq-monitor.png "SpotIQ Follow management interface")

* And you can click each headline to see the detailed performance over time, examine each interval, at the time scale you choose.
...
This release of ThoughtSpot leverages existing insights that are generated by the SpotIQ power users, and share them with everyone, regardless of their access to SpotIQ Analyze function.
...
Administrators can configure a welcoming experience for new users. In addition to assigning a user to the most relevant groups and Pinboards, they can customize a Welcome email to introduce them to ThoughtSpot and to get started.
...
- Email <a href="mailto:BetaProgram@thoughtspot.com?subject=Montor%20Beta%20Program%20Request" target="_blank">Monitor Beta Program</a> for AI-enabled guidance to deeper data insights.
