...
This release enhances Answer Explorer, which provides you AI-guided exploration of pinboards with a single click.
...
The enhancements to Answer Explorer include the following:
...
* Comparisons
  ...
  New section which allows you to easily do "versus" comparisons.
...
* Improved relevance
* Improved usability
* Column names appear separately from search values
* Undo goes back to the last change
