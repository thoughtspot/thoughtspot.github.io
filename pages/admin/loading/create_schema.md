...
-   **[Connect with TCL and create a schema](/pages/admin/loading/prep_schema_for_load.html)**  
...
-   **[Upload and run a SQL script)](/pages/admin/loading/upload_sql_script.html)**  
