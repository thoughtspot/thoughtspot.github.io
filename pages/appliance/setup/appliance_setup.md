...
4. Connect the data port(s) on the back of the appliance to your 10GbE network switch.
    ...
    ![](/pages/images/node_diagram_ivy_bridge.png "Ivy Bridge port to use for 10 GbE")

    ![](/pages/images/node_diagram_internal.png "Haswell port to use for 10 GbE")
...
5. Turn on the appliance by pressing and releasing the power button for each node and allow time for the nodes to boot up completely.
    ...
    ![](/pages/images/rack_diagram4.png "Location of the power and UID buttons on the control panel")
